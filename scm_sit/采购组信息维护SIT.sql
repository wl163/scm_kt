...
SELECT *  FROM cfg_parameter cfg WHERE param_name = 'RISK_STOCKING_SAP_FACTORY_MST' ;


select distinct purchase_group from sap_factory_material_mst where material_no='22001-000147_FDA' ;
select * from sop_purchase_group_config where factory_no='5520' and purchase_group = '313'

select * from dp_require_plan_base_factory where final_require_net_qty is null;
