update dp_require_plan_base as pb
        ...
        (
            ...
            (
                ...
                FROM
                (
                select rdc_inv_total,   # 期初RDC库存
                       plat_inv_total,  # 期初平台库存
                       cdc_inv_total,   # 期初CDC库存
                       whole_code,logic_whse_code,inv_last_update_time,sales_org_code from v_whole_machine_inv_pre
